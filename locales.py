...
TEXTS = {
    # --- Links ---
    "user_agreement_link_text": {
        "ru": "пользовательским соглашением",
        "en": "user agreement",
        "zh": "用户协议"
    },
    "user_agreement_url": {
        "ru": "https://telegra.ph/Polzovatelskoe-soglashenie--Terms-of-Service-08-07",
    ...
    "welcome_back": {
        ...
        "en": "Welcome back, {first_name}! What are you interested in today?",
        "zh": "欢迎回来, {first_name}! 今天您对什么感兴趣？"
    },
    ...
    "main_menu_prompt": {
        ...
        "en": "Select a section you are interested in:",
        "zh": "选择您感兴趣的部分："
    },
    ...
    "horoscope_disclaimer": {
        "ru": "Помните, что гороскоп носит развлекательный характер. Всегда проводите собственное исследование перед принятием финансовых решений.",
        "en": "Remember that the horoscope is for entertainment purposes. Always do your own research before making financial decisions.",
    ...
    "learning_tips": {
        "ru": [
            "🛡️ Всегда используйте аппаратные кошельки для хранения крупных сумм криптовалюты.",
            ...
            "🔑 Включайте двухфакторную аутентификацию на всех крипто-сервисах и никогда не делитесь сид-фразами.",
            "💸 Никогда не инвестируйте больше, чем можете позволить себе потерять без существенного ущерба.",
            "🔄 Крипторынок цикличный - покупайте, когда все продают, и фиксируйте прибыль, когда все покупают.",
            "📜 Всегда проверяйте контракты через блокчейн-эксплореры перед взаимодействием с новыми проектами.",
            "🗄️ Разделяйте средства на холодное хранение, стейкинг и активные торговые операции.",
            ...
            "🎣 Остерегайтесь 'rug pull' в DeFi: если доходность кажется слишком хорошей, чтобы быть правдой, вероятно, это мошенничество.",
            "🧠 В 'медвежьем' рынке лучшее вложение - это в свои знания. Изучайте новые технологии и протоколы."
        ],
        "en": [
            "🛡️ Always use hardware wallets to store large amounts of cryptocurrency.",
            ...
            "🔑 Enable two-factor authentication on all crypto services and never share your seed phrases.",
            "💸 Never invest more than you can afford to lose without significant damage.",
            "🔄 The crypto market is cyclical - buy when everyone is selling, and take profit when everyone is buying.",
            "📜 Always check contracts via blockchain explorers before interacting with new projects.",
            "🗄️ Separate your funds for cold storage, staking, and active trading operations.",
            ...
            "🎣 Beware of 'rug pulls' in DeFi: if a yield seems too good to be true, it's likely a scam.",
        ...
        "zh": [
            ...
            "🔑 在所有加密服务上启用双因素身份验证，绝不分享您的助记词。",
            "💸 绝不投资超过您能承受的损失。",
            "🔄 加密市场是周期性的 - 在大家都在卖出时买入，在大家都在买入时获利。",
            "📜 在与新项目互动之前，始终通过区块链浏览器检查合约。",
            "🗄️ 将您的资金分为冷存储、权益质押和主动交易操作。",
            ...
            "🎣 谨防DeFi中的'rug pulls'（拉地毯）：如果收益率好得令人难以置信，那很可能是一个骗局。",
    ...
    "support_info_text": {
        ...
        "zh": "有关所有建议、错误、问题或合作咨询，请联系我们的{support_link}。"
    }
}