...
TEXTS = {
    ...
    "learning_tips": {
        "ru": [
            ...
            "Используйте стратегию риск-менеджмента: определяйте размер позиции и стоп-лоссы перед сделкой",
        ...
        "en": [
            ...
            "Use a risk management strategy: determine your position size and stop-losses before a trade",
