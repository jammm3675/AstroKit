...
TEXTS = {
    ...
    "settings_menu_description": {
        ...
        "zh": "> Здесь вы можете настроить бота под себя. 🛠️"
    },
    "support_button": {
        "ru": "💌 Поддержка",
        "en": "💌 Support",
    ...
    "premium_menu_description": {
        ...
        "zh": "> Если вам нравится AstroKit, вы можете поддержать автора, отправив немного TON или используя Telegram Stars. Ваша поддержка помогает развивать проект! 🙏"
    },
    "premium_button_ton": {
